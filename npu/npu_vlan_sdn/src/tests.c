...
void init_group_table(void) 
{
    ...
    table->nodes[0].buckets[0].actions[2].value = 0x001;
    ...
    table->nodes[0].buckets[0].actions[4].value = 0x001;
    ...
    table->nodes[1].buckets[0].actions[4].value = 0x0002;
    ...
    table->nodes[1].buckets[0].actions[6].value = 0x0002;
               ...
               struct output_frame_context *ctrl_frame)
{
    ...
    if (pkt->port == 4 || pkt->port == 5) {
        lrn.actions_dst[0].type = ACTION_PUSH_VLAN;
        lrn.actions_dst[0].value = 0x0001;
    } else {
        lrn.actions_dst[0].type = ACTION_POP_VLAN;
